  ...
  return (
    <div id="contact" className="max-w-[1000px] mx-auto flex flex-col lg:flex-row text-white/70 p-8 rounded-lg space-y-8 lg:space-y-0 lg:space-x-8">
        ...
        <div className="bg-white/10 p-6 rounded-xl max-w-[1000px]">
            ...
            <form className="relative space-y-4" action="https://getform.io/f/ajjmyrda" method="POST">
                <div className="grid md:grid-cols-2 gap-4">
                    <input type="text" name="firstname" placeholder="Prénom" className="bg-black/70 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400 w-full" />
                    <input type="text" name="name" placeholder="Nom" className="bg-black/70 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400 w-full" />
